...
function buildDockerImage() {
    ...
    if (this.serverless.service.custom
        && this.serverless.service.custom.awsBatch
        && this.serverless.service.custom.awsBatch.CMD) {
        CMD = `CMD [ "${this.serverless.service.custom.awsBatch.CMD}" ]`
        
    }

    const baseDockerImage = `public.ecr.aws/lambda/python:${this.serverless.service.provider.runtime}`;
    ...
    RUN unzip -q ${this.serverless.service.service}.zip && rm ${this.serverless.service.service}.zip
